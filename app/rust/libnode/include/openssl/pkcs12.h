...
DEPRECATEDIN_1_1_0(ASN1_TYPE
*

PKCS12_get_attr(const PKCS12_SAFEBAG *bag, int attr_nid)
...
ASN1_TYPE *PKCS12_get_attr_gen(const STACK_OF(X509_ATTRIBUTE)
