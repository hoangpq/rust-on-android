...
void BIO_set_init(BIO * a, int
init);
int BIO_get_init(BIO * a);
void BIO_set_shutdown(BIO * a, int
shut);
...
void BIO_set_retry_reason(BIO * bio, int
reason);
...
int (*BIO_meth_get_write(BIO_METHOD *biom))
...
int (*BIO_meth_get_read(BIO_METHOD *biom))
...
int (*BIO_meth_get_puts(BIO_METHOD *biom))
...
int (*BIO_meth_get_gets(BIO_METHOD *biom))
...
long (*BIO_meth_get_ctrl(BIO_METHOD *biom))
...
int (*BIO_meth_get_create(BIO_METHOD *bion))
...
int (*BIO_meth_get_destroy(BIO_METHOD *biom))
